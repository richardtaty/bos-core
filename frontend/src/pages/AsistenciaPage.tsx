...
import type { Asistencia, DiaHorario, HorarioEsperado, PersonalRRHH, PersonaTrabajando } from "../types";
import {
  etiquetaMes,
  fmtDuracion,
  fmtFechaLarga,
...
// descuentos, alertas por hora, penalizaciones. Solo registra tiempo.
//
            ...
            <div key={fecha}>
              ...
              <div className="space-y-2">
                {sesiones.map((s) => (
                  <div
                    key={s.id}
                    className="bg-neutral-50 border border-neutral-200 rounded-xl p-3 flex flex-wrap items-center gap-x-6 gap-y-2"
                  >
