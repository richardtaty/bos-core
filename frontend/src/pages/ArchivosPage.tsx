  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-1">
        <h1 className="text-xl font-semibold text-neutral-900">Archivos</h1>
        <button
      ...
      <p className="text-sm text-neutral-500 mb-6">Biblioteca de archivos del departamento</p>

      {archivos.length === 0 ? (
        <div className="text-center py-12">
          <p className="text-4xl mb-3">📁</p>
          <p className="text-sm text-neutral-500 mb-4">No hay archivos todavía. Sube el primero.</p>
          <button
            onClick={() => setMostrarForm(true)}
            className="text-sm bg-primary-500 text-white px-4 py-2 rounded-lg hover:bg-primary-600"
          >
          ...
          {archivos.map((a) => (
            <div key={a.id} className="bg-neutral-50 border border-neutral-200 rounded-xl p-4 flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-neutral-900 truncate">{a.nombre}</p>
      ...
      {mostrarForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30" onClick={() => setMostrarForm(false)}>
          ...
          >
            <h3 className="text-lg font-semibold text-neutral-900 mb-4">Subir archivo</h3>
            ...
            <div className="flex gap-2 justify-end mt-5">
              <button onClick={() => setMostrarForm(false)} className="px-4 py-2 text-sm text-neutral-600 hover:bg-neutral-100 rounded-lg">
                Cancelar
              </button>
              <button
